...
import admin_calendar from "../components/admin/order/OrderCalendar.vue";
...
const routes: Array<RouteRecordRaw> = [
...

	{
		...
		children: [
			...
			{ path: "order/history", component: admin_order_history },
			{ path: "order/calendar", component: admin_order_calendar },
		],
	},
