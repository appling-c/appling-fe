  ...
  <div v-if="passwordcheck" class="max-w-4xl px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
    ...
    <div class="bg-white rounded-xl shadow p-4 sm:p-7 dark:bg-slate-900">
      <div class="mb-8">
        ...
        <p class="text-sm text-gray-600 dark:text-gray-400">수령지 정보와 비밀번호를 변경할 수 있어요.</p>
      </div>
      ...
      <form>
        ...
        <div class="grid sm:grid-cols-12 gap-2 sm:gap-6">
          <div class="sm:col-span-3">
            <label for="af-account-full-name" class="inline-block text-sm text-gray-800 mt-2.5 dark:text-gray-200"> 이름 </label>
          ...
          <div class="sm:col-span-3">
            <label for="af-account-full-name" class="inline-block text-sm text-gray-800 mt-2.5 dark:text-gray-200"> SNS 계정연동 </label>
          </div>
          <!-- End Col -->
          ...
          <div class="sm:col-span-3">
            <label for="af-account-full-name" class="inline-block text-sm text-gray-800 mt-2.5 dark:text-gray-200"> 닉네임 </label>
          </div>
          <!-- End Col -->
          ...
          <div class="sm:col-span-3">
            <label for="af-account-email" class="inline-block text-sm text-gray-800 mt-2.5 dark:text-gray-200"> Email </label>
          </div>
          <!-- End Col -->
          ...
          <div class="sm:col-span-3">
            <label for="af-account-email" class="inline-block text-sm text-gray-800 mt-2.5 dark:text-gray-200"> 권한 </label>
          </div>
          <!-- End Col -->
          ...
          <template v-if="role == '판매자'">
            <div class="sm:col-span-3">
              <label for="af-account-email" class="inline-block text-sm text-gray-800 mt-2.5 dark:text-gray-200"> 판매자 정보 </label>
            </div>
            <!-- End Col -->
            <div class="sm:col-span-9">
          ...
          <div class="sm:col-span-3">
            <label for="af-account-password" class="inline-block text-sm text-gray-800 mt-2.5 dark:text-gray-200"> 수령인 정보 </label>
          </div>
          <!-- End Col -->
          ...
          <div class="mt-6 grid gap-y-2">
            <a
              class="
                ...
                transition-all
                text-sm
                dark:bg-gray-800 dark:hover:bg-slate-800 dark:border-gray-700 dark:text-gray-400 dark:hover:text-white dark:focus:ring-offset-gray-800
              "
              href="#"
              >저장하기</a
            >
