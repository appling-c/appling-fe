<template>
  <div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
    ...
    <div class="grid md:grid-cols-2 items-center gap-12">
      <div>
        <h1 class="text-3xl font-bold text-gray-800 sm:text-4xl lg:text-5xl lg:leading-tight dark:text-white">🍎 애플링 가족이 되기</h1>
        <p class="mt-1 md:text-lg text-gray-800 dark:text-gray-200">🍎 애플링 서비스 가입을 위해 정보를 입력해주세요.</p>

        <div class="mt-8">
          <h2 class="text-lg font-semibold text-gray-800 dark:text-gray-200">이런 서비스를 이용할 수 있어요.</h2>

          <ul class="mt-2 space-y-2">
            <li class="flex space-x-3">
              <svg
                class="flex-shrink-0 h-6 w-6 text-gray-600 dark:text-gray-400"
                width="16"
                height="16"
                viewBox="0 0 16 16"
                fill="none"
              ...
              <span class="text-gray-600 dark:text-gray-400"> 처음 가입은 구매자로 가입됩니다. </span>
            </li>
            ...
            <li class="flex space-x-3">
              ...
              <span class="text-gray-600 dark:text-gray-400"> 관리자 승인을 통해 판매자 권한을 얻어 상품을 판매할 수 있어요. </span>
            </li>
            ...
            <li class="flex space-x-3">
              ...
              <span class="text-gray-600 dark:text-gray-400"> 인증된 사용자만 판매, 구매할 수 있어요. </span>
            </li>
          </ul>
        </div>
      </div>
      ...
      <div class="relative">
        ...
        <div class="flex flex-col border rounded-xl p-4 sm:p-6 lg:p-10 dark:border-gray-700">
          <h2 class="text-xl font-semibold text-gray-800 dark:text-gray-200">간단한 정보를 입력해주세요.</h2>

          <p class="mt-2 text-base text-gray-600 dark:text-gray-400">
            이미 계정이 있나요?
            <router-link to="/login" class="text-blue-600 decoration-2 hover:underline font-medium"> 여기서 로그인하기 </router-link>
          </p>

          <p @click="temp" class="mt-2 text-base text-gray-600 dark:text-gray-400">어둠의 경로로 가입 테스트하기</p>
          ...
          <div class="mt-3 flex">
            ...
            <div class="ml-3">
              <label for="remember-me" class="text-sm text-gray-600 dark:text-gray-400"
                ><a class="text-blue-600 decoration-2 hover:underline font-medium">약관</a>에 따라 본 서비스 이용에 동의합니다.</label
              >
            </div>
          </div>
          <!-- End Checkbox -->
