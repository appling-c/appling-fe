...
class CommonService {
  ...
  public async savebrandshophtml(payload: Object) {
    let htmlurl = "";
    await instance
      .post(ENDPOINT.API_COMMON_HTML, payload, {
        headers: {
    ...
    return instance.post(ENDPOINT.API_COMMON_HTML_REGIST, { url: htmlurl }).then((response: AxiosResponse) => {
      return response;
    });
  }

  public async callhtmlstring(payload: Object | String) {
    return await instance.get(`https://appling-s3.s3.ap-northeast-2.amazonaws.com/html/2/20230805/191541_0.html`, {}).then((response: AxiosResponse) => {
      return response;
    });
  }
  ...
  public async imageonserver(param): Promise<{} | []> {
    return await instance
      .post(ENDPOINT.API_COMMON_IMAGE, param, {
        headers: {
          "Content-Type": "application/x-www-form-urlencoded",
        },
      })
