		...
		<div class="max-w-3xl px-4 pt-6 lg:pt-10 pb-12 sm:px-6 lg:px-8 mx-auto">
			<div class="max-w-2xl">
								...
								<div>
									...
									>
										...
										>
											...
											<!-- Dropdown Card -->
											<div
												class="hs-tooltip-content hs-tooltip-shown:opacity-100 hs-tooltip-shown:visible opacity-0 transition-opacity inline-block absolute invisible z-10 max-w-xs cursor-default bg-gray-900 divide-y divide-gray-700 shadow-lg rounded-xl dark:bg-black"
												role="tooltip"
											>
												<!-- Body -->
				...
				<div class="space-y-5 md:space-y-8">
					<div id="viewer" class="p-1.5 min-w-full inline-block align-middle"></div>
				</div>
				<!-- End Content -->
			</div>
		</div>
...
<style>
	@import url("@toast-ui/editor/dist/toastui-editor-viewer.css");
</style>
