                  ...
                  <div class="max-w-2xl">
                    ...
                    <div class="space-y-5 md:space-y-8">
                      ...
                      >
                        <li class="pl-2">
                          판매가
                          <div class="text-gray-500 decoration-2 font-medium">
                            {{ price.toLocaleString() }}원 (원가 :
                        ...
                        <li class="pl-2">
                          ...
                          <div
                            v-html="notice1"
                            class="text-gray-500 decoration-2 font-medium"
                          ></div>
                        </li>
                        <li class="pl-2">
                          소비자안전을 위한 주의사항
  ...
  methods: {
    download() {
      ...
      html2canvas(element, {
        ...
        document
          .getElementById("btn-Convert-Html2Image")
          .setAttribute("download", "your_pic_name.png");
