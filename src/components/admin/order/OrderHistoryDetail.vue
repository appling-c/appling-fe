            ...
            >
              <div class="p-10">
                      ...
                      <dl class="grid sm:flex gap-x-3 text-sm">
                        ...
                        <dd class="font-medium text-gray-800 dark:text-gray-200">
                          ...
                          <address class="not-italic font-normal">
                            ...
                            {{ orderDeliveryInfo?.owner_address_detail }}<br />
                          </address>
                        </dd>
                      </dl>
                      ...
                      <dl class="grid sm:flex gap-x-3 text-sm">
                        ...
                        <dd class="font-medium text-gray-800 dark:text-gray-200">
                          ...
                          <address class="not-italic font-normal">
                            ...
                            {{ orderDeliveryInfo?.recipient_address }}<br />
                            {{ orderDeliveryInfo?.recipient_address_detail }}<br />
                          </address>
                        </dd>
                      </dl>
                    </div>
                ...
                >
                  ...
                  ></div>
                  <template v-for="item in orderItemList" :key="item.order_item_id">
            ...
            <div class="grid gap-4 mb-4 grid-cols-2">
              ...
              <div class="col-span-2 sm:col-span-1">
                ...
                >
                  ...
                  <option value="TV">배송준비중</option>
                  <option value="PC">주문취소</option>
                  <option value="GA">배송완료</option>
                </select>
              </div>
            </div>
