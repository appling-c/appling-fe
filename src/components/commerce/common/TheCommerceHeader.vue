<template>
  <header
    class="sticky top-0 inset-x-0 flex flex-wrap z-[48] sm:justify-start sm:flex-nowrap w-full bg-white border-b text-sm py-2.5 sm:py-4 lg:pl-64"
  >
    <nav
    ...
    >
      ...
      >
        <div class="mr-5 lg:mr-0">
          <a class="flex-none text-xl font-semibold" aria-label="Brand">🍎</a>
        </div>
        <div class="sm:hidden">
          <button
            type="button"
