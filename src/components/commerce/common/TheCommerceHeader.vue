  ...
  >
    <nav class="relative max-w-7xl w-full mx-auto px-4 sm:flex sm:items-center sm:justify-between sm:px-6 lg:px-8" aria-label="Global">
      <div class="flex items-center justify-between">
        <a @click="movetomain()" class="flex-none text-xl font-semibold dark:text-white" aria-label="Brand">🍎</a>
        <div class="sm:hidden">
          <button
            type="button"
            class="
                ...
                >
                  ...
                  <div class="grow">
                    <span class="block font-semibold mb-1 text-gray-800 dark:text-gray-200"
                      >판매자 권한 신청하기 <span class="inline ml-1 text-xs bg-blue-600 text-white py-1 px-2 rounded-full">New</span></span
                    >
