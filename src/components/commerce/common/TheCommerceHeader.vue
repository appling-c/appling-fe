<template>
  <header
    class="sticky top-0 inset-x-0 z-40 flex flex-wrap sm:justify-start sm:flex-nowrap w-full bg-white border-b text-sm py-2.5 sm:py-4 lg:pl-64"
  >
    <div class="flex items-center justify-between px-4 sm:px-6 md:px-8">
      <div class="sm:hidden">
        <button
          type="button"
