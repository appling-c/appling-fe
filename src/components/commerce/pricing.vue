  ...
  <div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 md:py-14 lg:py-20 mx-auto">
    ...
    <div class="space-y-4 lg:space-y-0">
      ...
      <ul class="grid lg:grid-cols-6 lg:gap-6">
        ...
        <!-- Item -->
        <li class="hidden lg:block lg:col-span-2 py-1.5 lg:py-3 px-4 lg:px-0 lg:text-center">
        </li>
        <!-- End Item -->
      ...
      <ul class="grid lg:grid-cols-6 lg:gap-6">
        ...
        <!-- Item -->
        <li class="col-span-2 py-1.5 lg:py-3 border-b border-gray-200 dark:border-gray-700">
