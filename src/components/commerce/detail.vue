  ...
  <div class="max-w-2xl">
    ...
    <div class="space-y-5 md:space-y-8">
      <div class="space-y-3">
        ...
        <p class="text-lg text-gray-800 dark:text-gray-200">{{main_explanation}}</p>
      </div>

      <p style="padding: 7rem; text-align: center;" class="text-lg text-gray-800 dark:text-gray-200" v-html="product_main_explanation"></p>

      <figure>
        <img class="w-full object-cover rounded-xl" :src="main_image" alt="Image Description">
