	...
	<div class="max-w-[85rem] px-4 py-5 sm:px-6 lg:px-8 lg:py-7 mx-auto">
		...
		<div class="max-w-2xl mx-auto text-center mb-10 lg:mb-14">
			...
			<p class="mb-10 mt-10 text-gray-600 dark:text-gray-400">
				농장에서 정성다해 키운<br />{{ totalProductCount }}개의 유기농 상품들이
				준비되어있어요!
			</p>
			<!-- Form -->
			<form>
				...
				>
					...
					<div class="flex-[0_0_auto]">
						<a
							class="p-4 inline-flex justify-center items-center gap-2 rounded-md border border-transparent font-semibold bg-blue-500 text-white hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-all text-base dark:focus:ring-offset-gray-800"
						>
							<svg
        ...
        <span class="absolute top-0 right-0 rounded-tr-xl rounded-bl-xl text-xs font-medium bg-gray-800 text-white py-1.5 px-3 dark:bg-gray-900">
          프리미엄
				...
				<h3
					class="mt-5 text-xl text-gray-800 dark:text-gray-300 dark:group-hover:text-white font-semibold"
				>
					{{ product.main_title }}
				</h3>
				...
				<p>
					<!-- Icon -->
					<span
						class="inline-flex justify-center items-center w-[46px] h-[46px] rounded-full text-gray-600"
					>
						<svg
					...
					<span>
						<span
							class="inline-flex items-center gap-1.5 py-1.5 px-3 rounded-full text-xs font-medium bg-red-600 text-white"
							>할인가</span
						>
