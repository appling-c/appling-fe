<template>
    ...
    <div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
        ...
        <p class="text-sm text-gray-600 dark:text-gray-400">
            구매자에게 공개될 판매 정보를 입력해 주세요. 모든 항목은 필수 입력 항목입니다. 
        </p>
        </div>
            <form>
        <!-- Grid -->
        <div class="grid sm:grid-cols-12 gap-2 sm:gap-6">
            ...
            <div class="sm:col-span-9">
                <div class="sm:flex">
                    <input type="text" v-model="tel" class="py-2 px-3 pr-11 block w-full border-gray-200 shadow-sm -mt-px -ml-px first:rounded-t-lg last:rounded-b-lg sm:first:rounded-l-lg sm:mt-0 sm:first:ml-0 sm:first:rounded-tr-none sm:last:rounded-bl-none sm:last:rounded-r-lg text-sm relative focus:z-10 focus:border-blue-500 focus:ring-blue-500 dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400" placeholder="01012345678">
                </div>
            </div>
            <!-- End Col -->
            ...
            <div class="sm:col-span-9">
                <div class="sm:flex">
                    <input type="text" v-model="email" class="py-2 px-3 pr-11 block w-full border-gray-200 shadow-sm -mt-px -ml-px first:rounded-t-lg last:rounded-b-lg sm:first:rounded-l-lg sm:mt-0 sm:first:ml-0 sm:first:rounded-tr-none sm:last:rounded-bl-none sm:last:rounded-r-lg text-sm relative focus:z-10 focus:border-blue-500 focus:ring-blue-500 dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400" placeholder="example@appling.com">
                </div>
            </div>
            <!-- End Col -->
