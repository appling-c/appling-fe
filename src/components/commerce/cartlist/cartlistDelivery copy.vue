            ...
            <div class="max-w-3xl px-4 pt-6 lg:pt-10 pb-12 sm:px-6 lg:px-8 mx-auto">
              <div class="max-w-2xl">
                ...
                <div class="space-y-5 md:space-y-5">
                  <div class="py-6">
                    <div class="space-y-3">
                      <h6 class="text-2xl font-bold md:text-3xl dark:text-white">
                        구매자 정보
                      </h6>
                  ...
                  <div class="py-6">
                    <div class="space-y-3">
                      <h4 class="text-2xl font-bold md:text-3xl dark:text-white">
                        주문내역
                      </h4>
                      <ul class="flex flex-col w-full">
                        ...
                        >
                          <div class="flex justify-between w-full">
                            ...
                            {{
                              (Number(iItem.ea) * Number(iItem.price)).toLocaleString()
                            }}원
                          </div>
                        </li>
                      </ul>
        ...
        <div class="max-w-2xl mx-auto">
          ...
          <div class="grid gap-12">
            <p class="mt-3 text-slate-800 dark:text-slate-400">
              ...
              위 주문 내용을 확인 하였으며, 회원 본인은 개인정보 이용 및 제공 및 결제에
              동의합니다.
            </p>
